...
This directory is reserved for Codex skill packaging work.
...
- keep bundled person-specific assets inside the corresponding skill package
- keep packaging notes and installation instructions with the skill package
